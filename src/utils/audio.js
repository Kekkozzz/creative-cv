 ...
 */
export function createWavHeader(dataLength, sampleRate, channels, bitsPerSample) {
 ...
 */
export function downsampleAudio(pcmBuffer, originalRate, targetRate) {
 ...
 */
export function getAudioDuration(pcmBuffer, sampleRate, channels, bitsPerSample) {
 ...
 */
export function hasAudioContent(pcmBuffer, threshold = 100) {
  let sumSquares = 0;
